...
class Database
{
    ...
    let dbname = "/Users/tonynguyen/Documents/Github/CPSC411-RestServer/Claims.sqlite"
    ...
    {
        let sqlStmt = "create table if not exists claim (id text, title text, date text, isSolved)"
